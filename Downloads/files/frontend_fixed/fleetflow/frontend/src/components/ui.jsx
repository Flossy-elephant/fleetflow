    ...
    <div className="fixed inset-0 z-50" onClick={onClose}>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          <div
            className="relative bg-surface-card border border-surface-border rounded-2xl w-full max-w-lg shadow-2xl fade-in my-8"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sticky top-0 z-10 bg-surface-card flex items-center justify-between px-5 py-4 border-b border-surface-border rounded-t-2xl">
