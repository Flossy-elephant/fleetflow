...
export function Modal({ open, onClose, title, children }) {
  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          <div
            className="relative bg-surface-card border border-surface-border rounded-2xl w-full max-w-2xl shadow-2xl fade-in my-4"
    ...
    document.body  // ← renders directly on body, outside all layouts
  );
}
